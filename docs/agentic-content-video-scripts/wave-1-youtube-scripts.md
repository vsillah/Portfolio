...
Current campaign decisions: keep long-form videos on the Agentified campaign calendar, target the AmaduTown YouTube channel and Agentified playlist, approve a usable HeyGen avatar pool and rotate across approved avatars by default, and reuse pending queue item `9f9dd8f1-9d19-48ff-bedf-2a5779a44be8` for Episode 1.
