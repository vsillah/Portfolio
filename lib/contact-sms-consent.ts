// Shared display/validation contract. Change the version whenever disclosure text changes.
export const SMS_DISCLOSURE_VERSION = 'amadutown-sms-2026-09-09-v1'
export const SMS_PROGRAM = 'AmaduTown Advisory Solutions LLC'
export const SMS_SCOPE = 'low-volume marketing and customer-care: business/technology consulting and AI automation'
export const SMS_DISCLOSURE = 'I agree to receive marketing and customer-care texts from AmaduTown Advisory Solutions LLC about consulting and AI automation services, including automated messages, at the number I provide. Message frequency varies. Message and data rates may apply. Consent is not a condition of purchase. Reply STOP to opt out or HELP for help. AmaduTown will not sell or share mobile information for third-party marketing or promotions.'
