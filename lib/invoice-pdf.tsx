...
export interface InvoicePDFOptions {
  /** Absolute URL for the logo image (e.g. origin + /amadutown-logo-upscaled.png). Omit to hide logo. */
  logoUrl?: string
}
 ...
 * Pass options.logoUrl (e.g. origin + '/amadutown-logo-upscaled.png') to include the AT logo in the header.
 */
