  ...
  try {
    ...
    const { data, error } = await supabaseAdmin
      ...
      .insert([{
        ...
        video_url: video_url && String(video_url).trim() ? String(video_url).trim() : null,
        video_thumbnail_url: video_thumbnail_url && String(video_thumbnail_url).trim() ? String(video_thumbnail_url).trim() : null,
        presentation_url: presentation_url && String(presentation_url).trim() ? String(presentation_url).trim() : null,
