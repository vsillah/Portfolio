                ...
                <div className="space-y-2 border-t border-gray-700 pt-4">
                  ...
                  {audit.tech_stack && (
                    ...
                    >
                      ...
                      {/* Website technologies (BuiltWith) — propagated from contact */}
                      {(() => {
                        const wt = (audit.tech_stack as Record<string, unknown>)?.website_technologies
                        if (!wt || typeof wt !== 'object' || !(wt as { domain?: string }).domain) return null
