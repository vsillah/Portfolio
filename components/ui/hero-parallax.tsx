...
export const HeroParallax = ({
  ...
  return (
    <div
      ref={ref}
      className="h-[320vh] py-40 overflow-hidden antialiased relative flex flex-col self-auto [perspective:1000px] [transform-style:preserve-3d] bg-background"
    >
      <Header />
      <motion.div
        style={{
...
export const ProductCard = ({
  ...
  return (
    ...
    >
      ...
      <h2 className="absolute bottom-4 left-4 opacity-0 group-hover/product:opacity-100 text-white font-bold text-xl pointer-events-none transition-opacity duration-300">
        {product.title}
      </h2>
    </motion.div>
  );
