        ...
        <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-10">
          {services.map((service, index) => (
            <motion.div
              ...
              className="group relative bg-silicon-slate/40 backdrop-blur-md rounded-2xl overflow-hidden border border-radiant-gold/5 hover:border-cyan-500/30 transition-all duration-500 cursor-pointer"
            >
              {/* Image / Icon area */}
              <div className="relative h-64 overflow-hidden">
                ...
                <div className="absolute top-6 left-6 flex flex-col gap-2">
                  <span className="px-3 py-1 bg-imperial-navy/80 backdrop-blur-md border border-cyan-500/30 rounded-full text-[10px] font-heading tracking-widest text-cyan-400 uppercase">
              ...
              <div className="p-8">
                ...
                <h3 className="font-premium text-2xl text-platinum-white group-hover:text-cyan-400 transition-colors mb-3">
                  {service.title}
                </h3>
                {service.description && (
                ...
                <div className="w-full flex items-center justify-center gap-3 py-3 border border-cyan-500/20 group-hover:bg-cyan-500/10 group-hover:border-cyan-500/40 rounded-full transition-all duration-300">
                  <span className="text-[10px] font-heading tracking-widest uppercase text-cyan-400">
                    View Details
                  </span>
