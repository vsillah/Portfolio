    ...
    <section id="music" className="py-32 px-6 sm:px-10 lg:px-12 bg-silicon-slate/5 relative overflow-hidden">
      ...
      <div className="max-w-7xl mx-auto relative z-10">
        ...
        >
          ...
          <p className="font-body text-muted-foreground/90 text-lg max-w-3xl mx-auto leading-relaxed">
          ...
          {musicEntries.map((entry, index) => {
            ...
            return (
              <motion.div
                ...
                className="group relative bg-background/40 backdrop-blur-md rounded-2xl overflow-hidden border border-radiant-gold/5 hover:border-radiant-gold/20 transition-all duration-500 flex flex-col"
              >
                {/* Album Image */}
                ...
                <div className="p-8 flex flex-col flex-grow relative z-10">
                  ...
                  <div className="flex flex-wrap gap-4 pt-6 border-t border-radiant-gold/5">
                    {entry.spotify_url && (
                      <a href={entry.spotify_url} target="_blank" rel="noopener noreferrer" className="text-muted-foreground/80 hover:text-radiant-gold transition-colors">
                        <ExternalLink size={18} />
                      </a>
                    )}
                    {entry.apple_music_url && (
                      <a href={entry.apple_music_url} target="_blank" rel="noopener noreferrer" className="text-muted-foreground/80 hover:text-radiant-gold transition-colors">
                        <Music2 size={18} />
                      </a>
                    )}
                  </div>
